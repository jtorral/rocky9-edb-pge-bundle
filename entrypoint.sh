...
# BIN DIR for enterprise db distro
...
# Create a group for proxysql prior to installing since this is a docker container

groupadd -r proxysql && useradd -r -g proxysql proxysql

# Get the repo and get ready to install proxysql
